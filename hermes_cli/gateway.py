...
_PLATFORMS = [
    ...
    {
        "key": "max",
        "label": "MAX (max.ru / VK Teams)",
        "emoji": "💬",
        "token_var": "MAX_BOT_TOKEN",
        "setup_instructions": [
            "1. Open MAX and message @MasterBot to create a bot",
            "2. Create a bot and copy MAX_BOT_TOKEN",
            "3. Add your bot to the target chat/channel",
            "4. Optional: set MAX_HOME_CHANNEL for cron/notification delivery",
        ],
        "vars": [
            {"name": "MAX_BOT_TOKEN", "prompt": "Bot token", "password": True,
             "help": "Paste the token generated by @MasterBot."},
            {"name": "MAX_ALLOWED_USERS", "prompt": "Allowed user IDs (comma-separated, optional)", "password": False,
             "is_allowlist": True,
             "help": "Restrict which MAX users can interact with the bot."},
            {"name": "MAX_HOME_CHANNEL", "prompt": "Home chat/channel ID (optional, for cron/notifications)", "password": False,
             "help": "Chat ID where cron results and notifications are delivered."},
        ],
    },
    {
        "key": "email",
